...
//         // Extract name and class/roll number from the link
...
//             const fullName = decodeURIComponent(nameClassArray[0].replace(/\+/g, " ")); // Decode and replace '+' with space
//             const className = nameClassArray[1];
//             const submissionTime = new Date().toLocaleString(); // Get current time
